...
class SideMenu extends Component {
	...
	showFormList(){
		...
		render(<FormLists />,document.getElementById('innerBody'));
	}
		...
		return (<div id="formList">
					<div className="formListContainer">	
						<div className="wrapper">
							<div className="box a" onclick="showFormOnClick();">
						  ...
						  <div className="box b">
								<div className="boxHeaderDiv">
										<div className="boxHeaderInnerDiv" onclick="">
											<span className="formTitleSideGap">
												 Survey Form
											</span>
									   </div>
							   ...
							   <div className="boxBobyDiv">	
									<img className="formImageSize" src="images/form1.png"/>											   
							   </div>
						  </div>
						  <div className="box c">
								<div className="boxHeaderDiv">
									   ...
									   <div className="formActionDiv">
											<a className="actionButton" onclick="showForm();"><i className="fa fa-eye faSsizeNew"></i></a>
											<a className="actionButton"><i className="fa fa-pencil-square-o faSsizeNew"></i></a>
											<a className="actionButton deleteFormData"><i className="fa fa-times faSsizeNew"></i></a>											
									   </div>
								</div>
							   <div className="boxBobyDiv">	
									<img className="formImageSize" src="images/form2.png"/>		
							   </div>
						  </div>								  								  
						</div>									
					</div>
